...
class Permlog {
    ...
    add_action('update_option_wp_user_roles', ['Permlog', 'updateWpUserRoles'], 10, 3);
    ...
    add_filter( 'civicrm_access_roles', ['Permlog', 'civicrmAccessRoles'], 10, 1);
    ...
    add_filter( 'civicrm_validateForm', ['Permlog', 'civicrmValidateForm'], 10, 5 );
	}
